...
bool Lab_3::init()
{
	...
	listener->onKeyPressed = CC_CALLBACK_2(Lab_3::onKeyPressed, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);


	/*listener onKeyReleased*/
	auto listenerReleased = EventListenerKeyboard::create();
	listenerReleased->onKeyReleased = CC_CALLBACK_2(Lab_3::onKeyReleased, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(listenerReleased, this);

	/*Update*/
	this->scheduleUpdate();
	this->schedule(schedule_selector(Lab_3::randomMoveEnemy), 0.08f);
	this->schedule(schedule_selector(Lab_3::randomMoveEnemy1), 0.08f);
	...
	contactListener->onContactBegin =
		CC_CALLBACK_1(Lab_3::onContactBegin, this);
...
*/
void Lab_3::onKeyPressed(EventKeyboard::KeyCode keyCode, Event* event) {
...
*/
void Lab_3::onKeyReleased(EventKeyboard::KeyCode keyCode, Event* event) {
	isKeyPressed = false;
	KeyPressed = 9999;
}
/*Move enemy*/
void Lab_3::randomMoveEnemy(float df) {
	int arrows[4];
...
void Lab_3::randomMoveEnemy1(float df) {
	int arrows[4];
	/*check way when sprite  is on the fork*/
	/*up and down*/
